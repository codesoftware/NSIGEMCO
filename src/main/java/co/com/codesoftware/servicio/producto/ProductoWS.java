...
public interface ProductoWS {
    ...
    @RequestWrapper(localName = "verificaProductoParametrizado", targetNamespace = "http://producto.servicio.codesoftware.com.co/", className = "co.com.codesoftware.servicio.producto.VerificaProductoParametrizado")
    @ResponseWrapper(localName = "verificaProductoParametrizadoResponse", targetNamespace = "http://producto.servicio.codesoftware.com.co/", className = "co.com.codesoftware.servicio.producto.VerificaProductoParametrizadoResponse")
    @Action(input = "http://producto.servicio.codesoftware.com.co/ProductoWS/verificaProductoParametrizadoRequest", output = "http://producto.servicio.codesoftware.com.co/ProductoWS/verificaProductoParametrizadoResponse")
    public String verificaProductoParametrizado(
