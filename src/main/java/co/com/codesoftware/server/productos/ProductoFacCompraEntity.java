...
/**
 * <p>Clase Java para productoFacCompraEntity complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="productoFacCompraEntity">
 *   &lt;complexContent>
 ...
 *         &lt;element name="producto" type="{http://productos.server.codesoftware.com.co/}productoEntity" minOccurs="0"/>
...
@XmlType(name = "productoFacCompraEntity", propOrder = {
    "cantidad",
    "estado",
    "fecha",
    "id",
...
public class ProductoFacCompraEntity {
