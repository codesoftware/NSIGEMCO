...
/**
 * <p>Clase Java para facturaCompraTotalEntity complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="facturaCompraTotalEntity">
 *   &lt;complexContent>
 ...
 *         &lt;element name="proveedor" type="{http://productos.server.codesoftware.com.co/}proveedoresEntity" minOccurs="0"/>
...
@XmlType(name = "facturaCompraTotalEntity", propOrder = {
    "estado",
    "fechaCreacion",
    "fechaFacCompra",
    "fechaRecepcion",
...
public class FacturaCompraTotalEntity {
