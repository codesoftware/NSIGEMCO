...
public interface AdministrationEndPoint {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "obtieneRepetidosTemporal", targetNamespace = "http://nsigemco.server.codesoftware.com.co/", className = "co.com.codesoftware.server.nsigemco.ObtieneRepetidosTemporal")
    @ResponseWrapper(localName = "obtieneRepetidosTemporalResponse", targetNamespace = "http://nsigemco.server.codesoftware.com.co/", className = "co.com.codesoftware.server.nsigemco.ObtieneRepetidosTemporalResponse")
    @Action(input = "http://nsigemco.server.codesoftware.com.co/AdministrationEndPoint/obtieneRepetidosTemporalRequest", output = "http://nsigemco.server.codesoftware.com.co/AdministrationEndPoint/obtieneRepetidosTemporalResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "obtieneRepetidosSistemaTemporal", targetNamespace = "http://nsigemco.server.codesoftware.com.co/", className = "co.com.codesoftware.server.nsigemco.ObtieneRepetidosSistemaTemporal")
    @ResponseWrapper(localName = "obtieneRepetidosSistemaTemporalResponse", targetNamespace = "http://nsigemco.server.codesoftware.com.co/", className = "co.com.codesoftware.server.nsigemco.ObtieneRepetidosSistemaTemporalResponse")
    @Action(input = "http://nsigemco.server.codesoftware.com.co/AdministrationEndPoint/obtieneRepetidosSistemaTemporalRequest", output = "http://nsigemco.server.codesoftware.com.co/AdministrationEndPoint/obtieneRepetidosSistemaTemporalResponse")
